...
`)
	gdbix.expectRegexp(`Address: \{[0-9a-f]{40}\}\n`)
}
...
`)
	...
	files, err := ioutil.ReadDir(filepath.Join(gdbix.Datadir, "keystore"))
	if len(files) != 1 {
...
// https://github.com/lofdev/go-dubaicoin/issues/1785
...
func TestUnlockFlagAmbiguous(t *testing.T) {
	...
	gdbix.setTemplateFunc("keypath", func(file string) string {
