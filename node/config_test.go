...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gdbix.ipc", false, filepath.Join(os.TempDir(), "gdbix.ipc")},
		{"data", "gdbix.ipc", false, "data/gdbix.ipc"},
		{"data", "./gdbix.ipc", false, "./gdbix.ipc"},
		{"data", "/gdbix.ipc", false, "/gdbix.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gdbix.ipc", true, `\\.\pipe\gdbix.ipc`},
		{"data", "gdbix.ipc", true, `\\.\pipe\gdbix.ipc`},
		{"data", `\\.\pipe\gdbix.ipc`, true, `\\.\pipe\gdbix.ipc`},
	}
